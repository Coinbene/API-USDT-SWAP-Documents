...
.地址
`wss://ws-contract.coinbene.vip/usdt/openapi/ws`
...
| 名称       | 格式                       | 示例                 |
| ---------- | -------------------------- | -------------------- |
| 深度列表   | orderBook.{symbol}.{depth} | orderBook.BTC-SWAP.10 |
| 最新成交   | tradeList.{symbol}         | tradeList.BTC-SWAP    |
| Ticker信息 | ticker.{symbol}            | ticker.BTC-SWAP       |
| K线数据    | kline.{symbol}             | kline.BTC-SWAP        |
